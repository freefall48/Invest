// https://observablehq.com/d/80523f348bb7c3b0@749
  ...
  main.variable(observer("breadcrumb")).define("breadcrumb", ["d3","breadcrumbWidth","breadcrumbHeight","sunburst","breadcrumbPoints","color"], function(d3,breadcrumbWidth,breadcrumbHeight,sunburst,breadcrumbPoints,color)
{
  ...
  main.variable(observer("viewof sunburst")).define("viewof sunburst", ["partition","data","d3","portfolioValue","radius","width","color","arc","mousearc"], function(partition,data,d3,portfolioValue,radius,width,color,arc,mousearc)
{
  ...
  svg
    ...
    .on("mouseleave", () => {
      path.attr("fill-opacity", d => d.children ? 1 : 0.7);
  ...
  main.variable(observer("portfolioValue")).define("portfolioValue", function(){return(
"0.00"
)});
  main.variable(observer("color")).define("color", ["d3"], function(d3){return(
d3.scaleOrdinal().range(["#2185d0","#0eb858"])
)});
...
`
  ...
  main.variable(observer("csv")).define("csv", ["d3","test"], function(d3,test){return(
d3.csvParseRows(test)
)});
